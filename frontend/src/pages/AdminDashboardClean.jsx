        ...
        <div className="container animate-fade-in">
            <div style={{ marginBottom: '3rem' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
                    {stats.map((s, idx) => (
                        <div key={s.label} className="glass" style={{ padding: '1.5rem', borderRadius: '16px', textAlign: 'center' }}>
            ...
            <motion.div className="glass" style={{ padding: '2rem', borderRadius: '24px', marginBottom: '3rem' }}>
            ...
            {pendingOrders > 0 && (
                <motion.div className="glass" style={{ padding: '1.25rem 2rem', borderRadius: '24px', marginBottom: '2.5rem', display: 'flex', alignItems: 'center', gap: '1.5rem', border: '1px solid rgba(245, 158, 11, 0.2)', background: 'linear-gradient(90deg, rgba(245, 158, 11, 0.05) 0%, transparent 100%)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
                {stats.map((s, idx) => (
                    <div key={s.label} className="glass" style={{ padding: '24px', borderRadius: '24px', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
                <motion.div className="glass" style={{ padding: '2rem', borderRadius: '24px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                ...
                                <div key={name} style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                    ...
                                    <div style={{ flex: 1 }}>
                                        ...
                                        <div style={{ height: '4px', background: 'rgba(255,255,255,0.05)', borderRadius: '2px', marginTop: '6px', overflow: 'hidden' }}>
                                            <div style={{ width: `${(count / topItems[0][1]) * 100}%`, height: '100%', background: i === 0 ? 'var(--primary)' : 'rgba(255,255,255,0.2)' }}></div>
                                        </div>
                                    </div>
                                    <button
                ...
                <motion.div className="glass" style={{ padding: '2rem', borderRadius: '24px', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
                        <Link to="/admin/food" style={{ textDecoration: 'none' }}>
                            <div className="glass" style={{ padding: '1.5rem', borderRadius: '16px', textAlign: 'center', cursor: 'pointer' }}>
                ...
                <Link to="/admin/users" style={{ textDecoration: 'none' }}>
                    <div className="glass" style={{ padding: '2rem', borderRadius: '24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
